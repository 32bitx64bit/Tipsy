...
var implementedMethods = map[string]bool{
	...
	"placeId()J":                                                               true,
	"userId()J":                                                                true,
	"conversationId()J":                                                        true,
	"referredByPlayerId()J":                                                    true,
	"joinRequestType()I":                                                       true,
	"accessCode()Ljava/lang/String;":                                           true,
	"callId()Ljava/lang/String;":                                               true,
	"eventId()Ljava/lang/String;":                                              true,
	"gameId()Ljava/lang/String;":                                               true,
	"gameIdToExclude()Ljava/lang/String;":                                      true,
	"gameJoinContext()Ljava/lang/String;":                                      true,
	"isoContext()Ljava/lang/String;":                                           true,
	"joinAttemptId()Ljava/lang/String;":                                        true,
	"joinAttemptOrigin()Ljava/lang/String;":                                    true,
	"launchData()Ljava/lang/String;":                                           true,
	"linkCode()Ljava/lang/String;":                                             true,
	"referralPage()Ljava/lang/String;":                                         true,
	"reservedServerAccessCode()Ljava/lang/String;":                             true,
	"appUserId()J":                                                             true,
	"isUnder13()Z":                                                             true,
