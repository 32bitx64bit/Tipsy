...
func testEGLSetupTraceFixture() bool {
	return C.tipsy_test_egl_setup_trace_fixture() != 0
}

func testEGLForegroundFixture() bool {
	return C.tipsy_test_egl_foreground_fixture() != 0
}
