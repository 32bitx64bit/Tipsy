...
void tipsy_x11_startup_measurement_set_map_observer(uintptr_t dpy_ptr, unsigned long xid, int enabled);
int tipsy_x11_startup_measurement_map_observed(uintptr_t dpy_ptr, unsigned long xid);
int tipsy_x11_startup_measurement_enable_drawable_observation(uintptr_t dpy_ptr, unsigned long xid);
void tipsy_x11_startup_measurement_disable_drawable_observation(uintptr_t dpy_ptr, unsigned long xid);
int tipsy_x11_startup_measurement_arm_drawable_observation(uintptr_t dpy_ptr, unsigned long xid);
int tipsy_x11_startup_measurement_take_drawable_observation(uintptr_t dpy_ptr, unsigned long xid);
int tipsy_x11_startup_measurement_dispatch_vertical_scroll(uintptr_t dpy_ptr, unsigned long xid);
void tipsy_x11_startup_measurement_test_clear(void);
void tipsy_x11_startup_measurement_test_observe_map(uintptr_t dpy_ptr, unsigned long xid);
void tipsy_x11_startup_measurement_test_observe_drawable(uintptr_t dpy_ptr, unsigned long xid);
